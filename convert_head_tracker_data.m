function convert_head_tracker_data(input_filename, output_filename, skip_time)
...
%   skip_time = number of seconds to delete off raw dataset
%
%outputs:
%   none
%
...
dt = 0.01; %Sample rate
samples_to_delete = floor(skip_time/dt);

TABLE = csvimport(input_filename);
table_size = size(TABLE);

TABLE_DATA = cell2mat(TABLE((samples_to_delete+2):table_size(1),1:9));
