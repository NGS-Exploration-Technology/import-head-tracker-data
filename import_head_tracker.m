function [Sim_Output, sim_time] = sim_ROV(Model_Params, Control_Params, Setpoint)
%SIM_ROV Main function for ROV simulator 
%function [Sim_Output, sim_time] = sim_ROV(Model_Params, Control_Params, Setpoint)
%
%inputs:
%   Model_Params = Data structure for model parameters
%   Control_Params = Data structure of control parameters
%   Setpoint = Controller Setpoints
%
%outputs:
%   Sim_Output = Simulation Output Data Structure
%   sim_time = [s] time to simulate
%
%See also SETUP_SIM_ROV PLOT_SIM_ROV RENDER_SIM_ROV RENDER_AUDIO_SIM_ROV
